 ...
 *    and submodule
 * @returns {function} A express route function
 */
exports.handler = function(root, lookup) {
    return function(req, res, next) {
        ...
        switch(module) {
            ...
            // A default action is probably needed here, but won't ever be hit
            // in ordinary circumstances provided the lookup object is properly
            // written
        }
    };
};